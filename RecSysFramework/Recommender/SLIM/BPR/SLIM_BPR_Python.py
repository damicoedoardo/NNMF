...
class SLIM_BPR_Python(BPR_Sampling, ItemSimilarityMatrixRecommender):
    ...
    def fit(self, epochs=30, logFile=None, URM_test=None, filterTopPop = False, minRatingsPerUser=1,
        ...
        for currentEpoch in range(epochs):
            ...
            if (URM_test is not None) and ((currentEpoch +1 )% validate_every_N_epochs == 0) and \
                ...
                self.write_current_config(currentEpoch+1, results_run, logFile)
    ...
    def write_current_config(self, currentEpoch, results_run, logFile):
