...
class SLIM_BPR_Cython(ItemSimilarityMatrixRecommender, EarlyStoppingModel):
    ...
    def load_model(self, folder_path='', file_name=None, gui=False):
        ...
        super(SLIM_BPR_Cython, self).load_model(folder_path=folder_path, file_name=file_name)
    ...
    def fit(self, epochs=300,
            ...
            topK = 200,
            sgd_mode='adagrad',
            gamma=0.995, beta_1=0.9,
            beta_2=0.999,
            **earlystopping_kwargs):


        # Import compiled module
        from RecSysFramework.Recommender.SLIM.BPR.Cython.SLIM_BPR_Cython_Epoch import SLIM_BPR_Cython_Epoch
